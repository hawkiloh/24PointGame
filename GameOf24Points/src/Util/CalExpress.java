...
public class CalExpress {
     ...
     * @return
     */
    public static Integer calculate(String exp) throws Exception{
        ArrayList<String>strings=getStringList(exp);
    ...
    public static void main(String[] args) throws Exception {
        CalExpress calExpress =new CalExpress();
        Scanner scanner=new Scanner(System.in);

        while (true){
            String exp=scanner.nextLine();
            int i= calExpress.calculate(exp);
